...
def upgrade() -> None:
    ...
    with op.batch_alter_table("activity_events", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_activity_events_meeting_id"),
            ["meeting_id"],
            unique=False,
        )
        batch_op.create_index(
        ...
        batch_op.create_index(
            batch_op.f("ix_activity_events_subject_id"),
            ["subject_id"],
            unique=False,
        )
    ...
    with op.batch_alter_table("comments", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_comments_meeting_id"), ["meeting_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_comments_parent_id"), ["parent_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_comments_project_id"), ["project_id"], unique=False
        )
        batch_op.create_index(
            "ix_comments_target", ["target_type", "target_id"], unique=False
        )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["project_id"], ["projects.id"], ondelete="SET NULL"),
        sa.ForeignKeyConstraint(
            ["source_comment_id"], ["comments.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(["user_id"], ["users.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    ...
    with op.batch_alter_table("notifications", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_notifications_kind"), ["kind"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_notifications_meeting_id"),
            ["meeting_id"],
            unique=False,
        )
        batch_op.create_index(
        ...
        batch_op.create_index(
            "ix_notifications_user_id_id", ["user_id", "id"], unique=False
        )
        batch_op.create_index(
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table("notifications", schema=None) as batch_op:
        batch_op.drop_index("ix_notifications_user_read_id")
        batch_op.drop_index("ix_notifications_user_id_id")
    ...
    with op.batch_alter_table("activity_events", schema=None) as batch_op:
        batch_op.drop_index(batch_op.f("ix_activity_events_subject_id"))
        batch_op.drop_index(batch_op.f("ix_activity_events_project_id"))
        batch_op.drop_index(batch_op.f("ix_activity_events_meeting_id"))
