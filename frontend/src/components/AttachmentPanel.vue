  ...
  <div class="attachment-panel">
    ...
    <div v-if="attachments.length" class="attachment-grid">
      <article v-for="attachment in attachments" :key="attachment.id" class="attachment-card">
        ...
        <div class="row-actions"><a class="button button-small button-quiet" :href="fileUrl(attachment)" download>下载</a><button class="button button-small button-danger" @click="remove(attachment)">删除</button></div>
      </article>
    </div>
