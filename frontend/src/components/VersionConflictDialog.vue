...
<template>
  <div class="dialog-backdrop" role="presentation">
    <section class="conflict-dialog" role="dialog" aria-modal="true" aria-labelledby="conflict-title">
      <header><div><p class="eyebrow">Version conflict</p><h2 id="conflict-title">内容已被其他成员更新</h2></div><button class="icon-button" aria-label="关闭" @click="emit('close')"><X :size="18" :stroke-width="2" aria-hidden="true" /></button></header>
